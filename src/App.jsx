          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={onLogout}
                  className="flex items-center space-x-2 text-white hover:text-red-500transition-colors text-sm font-bold"
                >
...
const LoadingSpinner = ({ size = "md" }) => {
  ...
  return (
    <div className="flex items-center justify-center w-full h-full">
      <div
        className={`${sizes[size]} border-4 border-red-500/30 border-t-red-500 rounded-full animate-spin`}
      />
    </div>
  );
};
